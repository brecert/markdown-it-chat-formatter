...
export default function modifyNewline(md: any) {
	const defaultParagraphRenderer = md.renderer.rules.paragraph_open || ((tokens: any[], idx: number, options: any, env: any, self: any) => self.renderToken(tokens, idx, options));
